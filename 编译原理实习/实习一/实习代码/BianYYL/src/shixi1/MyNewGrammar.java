...
public class MyNewGrammar/*@bgen(jjtree)*/implements MyNewGrammarTreeConstants, MyNewGrammarConstants {/*@bgen(jjtree)*/
  protected static JJTMyNewGrammarState jjtree = new JJTMyNewGrammarState();public static void main(String args [])
  {
    ...
    try {
        ...
        pw.print(inputpath+"\u7684\u8bcd\u6cd5\u5206\u6790\u7ed3\u679c\uff1a\u005cn");
        pw.print("TOKEN\u005ct"+"KIND\u005ct"+"LOCATION\u005cn");
        pw.flush();
    try
    {
      ...
      while(token.kind != 0) {
                pw.print(token.image+"\u005ct\u005ct"+token.kind+"\u005ct\u005ct"+"("+token.beginLine+","+token.beginColumn+")\u005cn");
                pw.flush();
 ...
 /*@bgen(jjtree) Integer */
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x50000000,0x50000000,0xa0000000,0xa0000000,0x4020080,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x8,0x8,0x0,};
   }
